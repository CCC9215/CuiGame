...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Image_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_overrideSprite_0);
            args = new Type[]{typeof(UnityEngine.Sprite)};
        ...
        static StackObject* set_overrideSprite_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
