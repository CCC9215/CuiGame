...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AssetBundle_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, LoadAllAssetsAsync_2);
            args = new Type[]{typeof(System.String)};
            ...
            app.RegisterCLRMethodRedirection(method, get_isStreamedSceneAssetBundle_4);
            args = new Type[]{};
            method = methods.Where(t => t.Name.Equals("LoadAllAssets") && t.CheckMethodParams(args)).Single();
            app.RegisterCLRMethodRedirection(method, LoadAllAssets_5);
        ...
        static StackObject* LoadAllAssetsAsync_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_isStreamedSceneAssetBundle_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
