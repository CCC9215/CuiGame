...
{
    unsafe class ProtoBuf_Meta_RuntimeTypeModel_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ProtoBuf.Meta.RuntimeTypeModel);
            args = new Type[]{};
        ...
        static StackObject* get_Default_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ProtoBuf.Meta.RuntimeTypeModel.Default;
